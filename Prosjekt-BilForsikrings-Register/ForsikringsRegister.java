...
public class ForsikringsRegister
{
  ...
  //Utvidder registeret med sأ¥ mange elementer som UTVIDELSE angir
  public void utvidRegister() {
    
    /* Lager en midlertidig array for أ¥ holde data, kopierer disse og opretter en
  ...
  //Gأ…R أ… LAGE EN BRUKER UTEN NAVN/ADRESSE. FIKS!!
